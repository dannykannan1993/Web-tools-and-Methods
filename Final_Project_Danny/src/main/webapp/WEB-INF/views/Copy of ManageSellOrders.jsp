	...
	<div id="wrapper">
		...
		<div class="page-content inset" data-spy="scroll" data-target="#spy">
			<div class="row">
				...
				<div id="content"></div>
				<c:choose>
					<c:when test="${sellingsize > 0}">
						<form action="GetCustomerSellingOrderItems">
							<div class="row clearfix" id="book-table">
								<div class="col-md-10 table-responsive">
									<table class="table table-bordered table-hover table-sortable"
										...
										<tbody>
											<c:forEach items="${sellingOrderList}" var="difforder">
												<tr id='addr0'>
			...
			<div>
				<c:choose>
					<c:when test="${sellingitemlistsize > 0}">
						<form ">
							<div class="row clearfix" id="book-table">
								<div class="col-md-10 table-responsive">
									<table class="table table-bordered table-hover table-sortable"
										...
										<tbody>
											...
											<c:forEach items="${sellingitemlist}" var="oi">
												<tr>
